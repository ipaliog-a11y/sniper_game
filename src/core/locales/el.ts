...
export const el: Dict = {
  ...
  'menu.exit': 'ΕΞΟΔΟΣ',
  'menu.exit_sub': 'αποθήκευση και έξοδος',
  'menu.quit_body': 'Η πρόοδος αποθηκεύτηκε. Μπορείς να κλείσεις αυτή την καρτέλα.',
  ...
  'settings.backup_section': 'ΑΝΤΙΓΡΑΦΟ ΑΣΦΑΛΕΙΑΣ',
  'settings.backup_note':
    'Η πρόοδος αποθηκεύεται αυτόματα σε αυτόν τον browser. Εξαγωγή JSON για ανάκτηση μετά από διαγραφή, ή μεταφορά σε άλλη συσκευή.',
  'settings.export': 'ΕΞΑΓΩΓΗ ΑΡΧΕΙΟΥ',
  'settings.export_done': 'Αποθηκεύτηκε {name}',
  'settings.export_fail': 'Αποτυχία λήψης αρχείου',
  'settings.import': 'ΕΙΣΑΓΩΓΗ ΑΡΧΕΙΟΥ',
  'settings.import_busy': 'ΕΠΙΛΕΞΕ ΑΡΧΕΙΟ…',
  'settings.import_ready': 'Φορτώθηκε — πάτα Εισαγωγή ξανά για αντικατάσταση',
  'settings.import_confirm': 'ΠΑΤΑ ΞΑΝΑ ΓΙΑ ΑΝΤΙΚΑΤΑΣΤΑΣΗ ΠΡΟΟΔΟΥ',
  'settings.import_done': 'Η πρόοδος επαναφέρθηκε από αρχείο',
  'settings.import_fail': 'Άκυρο ή ακυρωμένο αρχείο',
  'settings.import_note': 'αντικαθιστά εξοπλισμό, credits, σκορ και καριέρα σε αυτή τη συσκευή',
