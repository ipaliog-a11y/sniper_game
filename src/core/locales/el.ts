...
export const el: Dict = {
  ...
  'coach.verify.elev':
    'Ρύθμισε ύψος μέχρι η «περίπου απόσταση» να είναι κοντά στα {range} (τώρα ≈ {about})',
  ...
  'coach.step.pick_row.title': 'Εστίασε στην πλάκα 150 m',
  'coach.step.pick_row.body':
    'Θα εξασκηθούμε στη μεσαία πλάκα (150 m). Σημείωσε το ΥΨΟΣ (mil) στην κάρτα. Μετά θα ρυθμίσεις μέχρι ο πίνακας πυργίσκων να λέει «περίπου 150 m» — έτσι πιάνεις λάθος φορά ρύθμισης.',
  ...
  'coach.step.dial_elev.title': 'Σειρά σου — ρύθμισε για 150 m',
  'coach.step.dial_elev.body':
    'Χρησιμοποίησε τα ζωντανά χειριστήρια κάτω από το στιγμιότυπο. Ρύθμισε ύψος μέχρι η «περίπου απόσταση» να είναι κοντά στα 150 m. Στο αρχικό σκοπευτικό MOA μην μετατρέπεις mil — μετράει μόνο η γραμμή απόστασης. Το ΕΠΟΜΕΝΟ μένει κλειδωμένο μέχρι να είσαι αρκετά κοντά.',
