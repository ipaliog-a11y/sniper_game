...
export const en: Dict = {
  ...
  'menu.exit': 'EXIT',
  'menu.exit_sub': 'save progress and leave',
  'menu.quit_body': 'Progress saved. You can close this tab.',
  ...
  'settings.sound_section': 'SOUND',
  'settings.sound': 'MASTER',
  'settings.sound_note': 'all audio on or off',
  'settings.master_volume': 'MASTER VOLUME',
  'settings.sound_sfx': 'MAIN SOUNDS',
  'settings.sound_sfx_note': 'shots, impacts, bolt, UI clicks',
  'settings.sound_env': 'ENVIRONMENT',
  'settings.sound_env_note': 'wind bed on the range',
  ...
  'settings.export_done': 'Saved {name}',
  'settings.export_fail': 'Could not download save file',
  'settings.import': 'IMPORT SAVE FILE',
  'settings.import_busy': 'CHOOSE A FILE…',
  'settings.import_ready': 'Save loaded — tap Import again to replace progress',
  'settings.import_confirm': 'TAP AGAIN TO REPLACE PROGRESS',
  'settings.import_done': 'Progress restored from file',
  'settings.import_fail': 'Invalid or cancelled save file',
  'settings.import_note': 'replaces kit, credits, scores and career on this device',
